...
- ✅ MySQL database support for persistent data storage
...
```env
DATABASE_URL=mysql+pymysql://user:password@127.0.0.1:3306/studentdb
```

Make sure a MySQL server is running and the database exists.
...
- Data now persists in MySQL instead of the local SQLite file.
